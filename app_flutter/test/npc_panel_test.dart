...
void main() {
  ...
  const forgeLocationId = 'LOC-0046';
  ...
  testWidgets('the tanner talk button opens the hide shop', (tester) async {
    var closed = 0;
    var opened = 0;
    final controller = buildController(database, seed: standing('LOC-0025'));
    addTearDown(controller.dispose);
